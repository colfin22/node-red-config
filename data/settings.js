...
module.exports = {
    // adminAuth-injected
    adminAuth: { type: "credentials", users: [{ username: process.env.NR_ADMIN_USER || "admin", password: process.env.NR_ADMIN_HASH || "", permissions: "*" }] }, // credentials from gitignored .env
